...
enum FurnaceGUIColors {
  ...
  GUI_COLOR_SPECTRUM_FILL,
  GUI_COLOR_SPECTRUM_OUTLINE,
  GUI_COLOR_SPECTRUM_PEAK,
...
class FurnaceGUI {
  ...
  bool visualizerOpen;
  bool rgbSync;
  char browserURLBuf[2048];
  std::vector<String> browserHistory;
  int browserHistoryPos;
  ...
  struct SpectrumSettings {
    ...
    SpectrumSettings():
      ...
      gradientFill(true) {
        ...
        memset(smooth,0,DIV_MAX_OUTPUTS*sizeof(float*));
