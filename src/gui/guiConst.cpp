...
const FurnaceGUIColorDef guiColors[GUI_COLOR_MAX]={
  ...
  D(GUI_COLOR_SPECTRUM_FILL,"",ImVec4(0.4f,0.7f,1.0f,0.35f)),
  D(GUI_COLOR_SPECTRUM_OUTLINE,"",ImVec4(0.7f,0.9f,1.0f,1.0f)),
  D(GUI_COLOR_SPECTRUM_PEAK,"",ImVec4(1.0f,0.85f,0.3f,1.0f)),
