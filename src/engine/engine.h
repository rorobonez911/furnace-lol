...
#define DIV_VERSION "furnace-lol"
...
class DivEngine {
  ...
  bool loadVGM(unsigned char* file, size_t len);
 ...
 //sample banks
  ...
  public:
    ...
    float* chipOscBuf[DIV_MAX_CHIPS];
    float oscSize;
    ...
    DivEngine():
      ...
      memset(chipOscBuf,0,DIV_MAX_CHIPS*(sizeof(float*)));
